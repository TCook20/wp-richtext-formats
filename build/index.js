...
const EditMaterialIcon = ({
  isActive,
  onChange,
  value
}) => {
  const [responseData, setResponseData] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)();
  const [iconList, setIconList] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)([]);
  const [filterTerm, setFilterTerm] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)('');
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    axios__WEBPACK_IMPORTED_MODULE_4__["default"].get(codepointsUrl).then(response => setResponseData(response.data.split('\n'))).catch(error => {
  ...
  const iconSelectorHandler = selectedValue => {
    ...
    const toInsert = (0,_wordpress_rich_text__WEBPACK_IMPORTED_MODULE_3__.applyFormat)((0,_wordpress_rich_text__WEBPACK_IMPORTED_MODULE_3__.create)({
      text: selectedValue
    }), {
      type: 'mizzou/material-icon'
    }, 0, selectedValue.length);
    onChange((0,_wordpress_rich_text__WEBPACK_IMPORTED_MODULE_3__.insert)(value, toInsert));
  };
  if (iconList && !filteredList) {
    iconGallery = iconList.map((icon, i) => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
      size: "compact",
      key: i,
      label: icon,
      onClick: () => iconSelectorHandler(icon)
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("i", {
      className: "miz-icon miz-icon--xl material-icons"
    }, icon)));
  } else if (filteredList) {
    iconGallery = filteredList.map((icon, i) => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
      size: "compact",
      key: i,
      label: icon,
      onClick: () => iconSelectorHandler(icon)
  ...
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, "Select an icon to insert."), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.SearchControl, {
    value: filterTerm,
    onChange: newFilter => setFilterTerm(newFilter)
  }), iconGallery)));
};
/* harmony default export */ __webpack_exports__["default"] = (EditMaterialIcon);
...
(0,_wordpress_rich_text__WEBPACK_IMPORTED_MODULE_0__.registerFormatType)('mizzou/material-icon', {
  title: 'Material Icon',
  tagName: 'i',
