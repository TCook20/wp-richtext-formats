...
function SearchEdit({
  ...
  const layout = (0, _blockEditor.useSetting)('layout');
  ...
  }, (isButtonPositionInside || isButtonPositionOutside || hasOnlyButton) && (0, _element.createElement)(_element.Fragment, null, renderTextField(), renderButton()), hasNoButton && renderTextField()));
}
