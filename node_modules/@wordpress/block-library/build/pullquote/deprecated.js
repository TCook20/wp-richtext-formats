...
function multilineToInline(value) {
  return (0, _richText.toHTMLString)({
    value: (0, _richText.replace)((0, _richText.create)({
      html: value,
      multilineTag: 'p'
    }), new RegExp(_richText.__UNSTABLE_LINE_SEPARATOR, 'g'), '\n')
  });
}
const v5 = {
  attributes: {
  ...
  save({
    ...
    }, (0, _element.createElement)("blockquote", null, (0, _element.createElement)(_blockEditor.RichText.Content, {
      value: value,
      multiline: true
    }), shouldShowCitation && (0, _element.createElement)(_blockEditor.RichText.Content, {
      tagName: "cite",
      value: citation
    })));
  },
 ...
 */
var _default = [v5, v4, v3, v2, v1, v0];
