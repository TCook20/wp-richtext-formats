...
function PostTitleEdit({
  ...
  let titleElement = (0, _element.createElement)(TagName, {
    ...blockProps
  }, (0, _i18n.__)('Title'));
  if (postType && postId) {
    titleElement = userCanEdit ? (0, _element.createElement)(_blockEditor.PlainText, {
      tagName: TagName,
  ...
  if (isLink && postType && postId) {
    titleElement = userCanEdit ? (0, _element.createElement)(TagName, {
      ...blockProps
  ...
  return (0, _element.createElement)(_element.Fragment, null, blockEditingMode === 'default' && (0, _element.createElement)(_blockEditor.BlockControls, {
    group: "block"
  }, (0, _element.createElement)(_blockEditor.HeadingLevelDropdown, {
    value: level,
