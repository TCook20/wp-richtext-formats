...
function TemplatePartEdit({
  ...
  if (innerBlocks.length === 0 && (slug && !theme || slug && isMissing)) {
    return (0, _element.createElement)(TagName, {
      ...blockProps
    }, (0, _element.createElement)(_blockEditor.Warning, null, (0, _i18n.sprintf)( /* translators: %s: Template part slug */
  ...
  return (0, _element.createElement)(_element.Fragment, null, (0, _element.createElement)(_blockEditor.__experimentalRecursionProvider, {
  ...
  }), isPlaceholder && (0, _element.createElement)(TagName, {
    ...blockProps
  }, (0, _element.createElement)(_placeholder.default, {
    ...
    hasInnerBlocks: innerBlocks.length > 0,
    layout: layout
  }), !isPlaceholder && !isResolved && (0, _element.createElement)(TagName, {
    ...blockProps
  }, (0, _element.createElement)(_components.Spinner, null))), isTemplatePartSelectionOpen && (0, _element.createElement)(_components.Modal, {
