...
function CommentTemplateInnerBlocks({
  ...
  return (0, _element.createElement)("li", {
    ...innerBlocksProps
  }, comment.commentId === (activeCommentId || firstCommentId) ? children : null, (0, _element.createElement)(MemoizedCommentTemplatePreview, {
    blocks: blocks,
    commentId: comment.commentId,
    setActiveCommentId: setActiveCommentId,
    isHidden: comment.commentId === (activeCommentId || firstCommentId)
  }), comment?.children?.length > 0 ? (0, _element.createElement)(CommentsList, {
...
const CommentsList = ({
  ...
  commentId,
  ...comment
}, index) => (0, _element.createElement)(_blockEditor.BlockContextProvider, {
