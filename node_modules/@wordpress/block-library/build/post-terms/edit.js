...
function PostTermsEdit({
  ...
  return (0, _element.createElement)(_element.Fragment, null, (0, _element.createElement)(_blockEditor.BlockControls, null, (0, _element.createElement)(_blockEditor.AlignmentToolbar, {
    ...
    ...blockProps
  }, isLoading && hasPost && (0, _element.createElement)(_components.Spinner, null), !isLoading && hasPostTerms && (isSelected || prefix) && (0, _element.createElement)(_blockEditor.RichText, {
    ...
    tagName: "span"
  }), (!hasPost || !term) && (0, _element.createElement)("span", null, blockInformation.title), hasPost && !isLoading && hasPostTerms && postTerms.map(postTerm => (0, _element.createElement)("a", {
    key: postTerm.id,
    href: postTerm.link,
    onClick: event => event.preventDefault()
  }, (0, _htmlEntities.decodeEntities)(postTerm.name))).reduce((prev, curr) => (0, _element.createElement)(_element.Fragment, null, prev, (0, _element.createElement)("span", {
    className: "wp-block-post-terms__separator"
  }, separator || ' '), curr)), hasPost && !isLoading && !hasPostTerms && (selectedTerm?.labels?.no_terms || (0, _i18n.__)('Term items not found.')), !isLoading && hasPostTerms && (isSelected || suffix) && (0, _element.createElement)(_blockEditor.RichText, {
    allowedFormats: ALLOWED_FORMATS,
