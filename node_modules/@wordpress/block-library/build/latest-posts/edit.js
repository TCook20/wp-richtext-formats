...
function LatestPostsEdit({
  ...
  if (!hasPosts) {
    return (0, _element.createElement)("div", {
      ...blockProps
    }, inspectorControls, (0, _element.createElement)(_components.Placeholder, {
      icon: _icons.pin,
  ...
  return (0, _element.createElement)("div", null, inspectorControls, (0, _element.createElement)(_blockEditor.BlockControls, null, (0, _element.createElement)(_components.ToolbarGroup, {
    ...
    const postExcerpt = needsReadMore ? (0, _element.createElement)(_element.Fragment, null, excerpt.trim().split(' ', excerptLength).join(' '), (0, _element.createInterpolateElement)( /* translators: excerpt truncation character, default …  */
    (0, _i18n.__)(' … <a>Read more</a>'), {
      a:
