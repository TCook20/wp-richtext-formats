...
export default function LatestPostsEdit({
  ...
  return createElement("div", null, inspectorControls, createElement(BlockControls, null, createElement(ToolbarGroup, {
    ...
    const postExcerpt = needsReadMore ? createElement(Fragment, null, excerpt.trim().split(' ', excerptLength).join(' '), createInterpolateElement( /* translators: excerpt truncation character, default …  */
    __(' … <a>Read more</a>'), {
      a:
