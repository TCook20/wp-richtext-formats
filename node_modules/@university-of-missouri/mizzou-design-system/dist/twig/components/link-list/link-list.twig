...
{% macro LinkList( options ) %}
  {%- spaceless %}
    ...
    {% from "@miz/components/link-list/link-list.twig" import LinkListItem as linkListItem %}
    {% from "@miz/components/link-list/link-list.twig" import LinkListLink as linkListLink %}
