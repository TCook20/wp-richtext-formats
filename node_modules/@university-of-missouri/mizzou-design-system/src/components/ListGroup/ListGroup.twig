...
{% macro ListGroup( options ) %}
  {%- spaceless %}
    ...
    {% from "@miz/components/ListGroup/ListGroup.twig" import ListGroupItem as listGroupItem %}
...
{% macro ListGroupItem( options ) %}
  {%- spaceless %}
    ...
    {# Imports #}
    {% import "@miz/utilities/twig/utils.twig" as utils %}
    {% from "@miz/components/ListGroup/ListGroup.twig" import ListGroupLink as listGroupLink %}
